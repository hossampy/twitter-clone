...
const getFile = (e) => {
    // Extract the selected file from the input event object and assign it to the file ref
    file.value = e.target.files[0];

    // Create a URL for the selected file and assign it to the showUpload ref
    showUpload.value = URL.createObjectURL(e.target.files[0]);

    // Extract the file extension from the filename and assign it to the uploadType ref
...
const textareaInput = (e) => {
    ...
    //sets the height of the textarea to match its scrollHeight,
    // ensuring that all the content is visible without scrolling.
